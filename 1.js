...
// (его тоже необходимо создать рядом с html-файлом). В js-файле 
...
// const b = ((9 / 5) * a + 32);
// alert(`t в градусах Цельсия: ${a}\nt в градусах Фаренгейт: ${b}`);

//с округлением 
const a = Number.parseFloat(prompt("Введите температуру в градусах Цельсия:"));
const b = ((9 / 5) * a + 32);
alert(`t в градусах Цельсия: ${a.toFixed(2)}\nt в градусах Фаренгейт: ${b.toFixed(2)}`);